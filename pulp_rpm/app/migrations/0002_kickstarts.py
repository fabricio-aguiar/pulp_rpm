# Generated by Django 2.2.4 on 2019-08-27 17:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repository', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='core.Repository')),
            ],
            options={
                'unique_together': {('variant_id', 'uid', 'name', 'type', 'packages')},
            },
        ),
        migrations.CreateModel(
            name='Image',
            ...
            options={
                'unique_together': {('name', 'path', 'platform', 'distribution_tree')},
            },
        ),
        migrations.CreateModel(
            name='Checksum',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repository', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='addons', to='core.Repository')),
            ],
            options={
                'unique_together': {('addon_id', 'uid', 'name', 'type', 'packages')},
            },
        ),
    ]
