...
class Addon(Model):
    ...
    addon_id = models.CharField(max_length=30)
    uid = models.CharField(max_length=30)
    name = models.CharField(max_length=20)
    type = models.CharField(max_length=20)
    packages = models.CharField(max_length=30)
    distribution_tree = models.ForeignKey(
...
class Variant(Model):
    ...
    source_packages = models.CharField(max_length=20, null=True)
    source_repository = models.CharField(max_length=20, null=True)
    debug_packages = models.CharField(max_length=20, null=True)
    debug_repository = models.CharField(max_length=20, null=True)
